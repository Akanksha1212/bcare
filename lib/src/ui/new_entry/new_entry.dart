...
import 'package:bcare/src/common/convert_time.dart';
import 'package:bcare/src/global_bloc.dart';
import 'package:bcare/src/models/errors.dart';
import 'package:bcare/src/models/medicine.dart';
import 'package:bcare/src/models/medicine_type.dart';
            ...
            child: Center(
              child: Padding(
                ...
                child: Icon(
                  ...
                  size: 75,
                  color: isSelected ? Colors.white : Color(0xff90b7e2),
                ),
              ),
            ),
          ),
